...
# class_names = ["Pho", "Banh xeo", "Banh mi", "Goi cuon", "Com tam"]
...
# # predict all images in the folder dataset(5dishes)/test
...
# #             prediction = predict_dish(image_path)
# #             print("File:", filename)
# #             print("Prediction:", prediction)
# # # Example usage
# # # image_path = "dataset(5dishes)/test/banhmi.jpg"
# # # predict_dish(image_path)


# # predict_all_images_in_folder("dataset(5dishes)/test/Pho")
